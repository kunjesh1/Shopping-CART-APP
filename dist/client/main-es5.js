...
var routingComponents = [_login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"], _sign_up_sign_up_component__WEBPACK_IMPORTED_MODULE_4__["SignUpComponent"], _user_profile_user_profile_component__WEBPACK_IMPORTED_MODULE_5__["UserProfileComponent"]];
        ...
        router.events.forEach(function (event) {
            if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationStart"]) {
                if (event['url'] == '/login') {
                    ...
                    console.log("this.showHead" + _this.showHead);
                    _this.showHead = true;
                }
            }
        });
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, userService, formBuilder) {
        this.router = router;
        this.userService = userService;
...
var ProductFormComponent = /** @class */ (function () {
    function ProductFormComponent(categoryService, router, productService, route, toastr) {
        var _this = this;
    ...
    ProductFormComponent.prototype.onSave = function (product) {
        var _this = this;
        if (this.productId) {
            console.log("patching");
            this.productService.updateProduct(this.productId, product).subscribe(function (result) { return console.log("Updated successfully" + result); }, function (err) { return console.log(err); }, function () { _this.toastr.success("Updated successfully"); });
        }
        else {
            this.productService.saveProducts(product).subscribe(function (result) {
    ...
    ProductFormComponent.prototype.getProducts = function () {
        this.productService.getProductbyId(this.productId).subscribe(function (result) {
            console.log(result);
        });
    };
...
var ProductsComponent = /** @class */ (function () {
    ...
    ProductsComponent.prototype.ngOnInit = function () {
        var _this = this;
        console.log();
        this.subscription = this.productService.getProducts().subscribe(function (products) {
            _this.products = products;
            _this.listData = new _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](_this.products);
    ...
    ProductsComponent.prototype.onSearchClear = function () {
        this.searchKey = "";
        this.applyFilter();
    };
    ...
    ProductsComponent.prototype.onDelete = function (id) {
        var _this = this;
        this.productService.deleteProduct(id).subscribe(function (result) { return console.log(result); }, function (err) { return console.log(err); });
...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.updateProduct = function (id, obj) {
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getStatus = function (data) {
...
var ShoppingBlockComponent = /** @class */ (function () {
    function ShoppingBlockComponent() {
    }
    ShoppingBlockComponent.prototype.ngOnInit = function () {
    };
...
var SignUpComponent = /** @class */ (function () {
    function SignUpComponent(formBuilder, router, userService, toastr) {
        this.formBuilder = formBuilder;
        this.router = router;
        this.userService = userService;
        this.toastr = toastr;
    ...
    SignUpComponent.prototype.onSubmit = function () {
        ...
        this.userService.postUser(this.registerForm.value)
            ...
            _this.toastr.success("User Successfully Created");
            _this.router.navigateByUrl('/login');
        });
    };
...
var UserProfileComponent = /** @class */ (function () {
    function UserProfileComponent(userService, router, http) {
        this.userService = userService;
        this.router = router;
        this.http = http;
    ...
    UserProfileComponent.prototype.onFileUpload = function (file) {
        var _this = this;
        console.log(file);
